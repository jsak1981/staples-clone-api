...
* The original package name 'com.ecommerce.staples-clone' is invalid and this project uses 'com.ecommerce.staples_clone' instead.
...
* [Spring for RabbitMQ](https://docs.spring.io/spring-boot/3.4.10/reference/messaging/amqp.html)
